...
{
    public abstract class TestAutomapperWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TestAutomapperWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TestAutomapperWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TestAutomapperDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TestAutomapperDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TestAutomapperDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TestAutomapperDbContext, Task<T>> func)
        {
            T result;
